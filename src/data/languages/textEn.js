const textEn = {
  en: {
    ...
    aboutPage: {
      intro: `Thank you for coming here with an interest in getting to know better who we are.
      ...
      Here at Utópika, we deeply understand the concepts that our partners are debating and we join forces because we have the desire to make the transformation really happen and to become part of these stories through the visual narratives that we produce with this engagement.
      We go hand in hand and heart aligned with multi-talented professionals from different disciplines and knowledge, so, no matter the size of the challenge, we mobilize the necessary team to make design, illustration, audiovisual and animation projects happen, whether on the on or off platforms .
