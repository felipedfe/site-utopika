...
const textPt = {
  pt: {
    ...
    introduction: {
      introPt1: "A comunicação que fazemos hoje é o impacto que colhemos amanhã!",
      introPt2: "Queremos caminhar lado a lado de quem transforma realidades, criando narrativas que informam, mobilizam e inspiram novas formas de existir. Porque a comunicação é uma ferramenta poderosa para criar novas visões de mundo e construir o futuro que queremos!",
      button: "Saiba +",
    },
    instaFeed: {
      title: "NOVIDADES"
    ...
    aboutPage: {
      intro: {
        title: 'Utopiar é transformar o futuro',
        paragraph1: `Aqui na Utópika, acreditamos que a comunicação é uma ferramenta de transformação e parte da solução dos problemas que enfrentamos no mundo!`,
        paragraph2: `Nosso compromisso é contar histórias que importam, amplificar vozes que precisam ser ouvidas e criar campanhas que provoquem mudanças reais. Atuamos na interseção entre criatividade e impacto, construindo imagens que carregam propósito.`,
        paragraph3: `Caminhamos lado a lado com a organizações, movimentos sociais, e marcas, que estão reimaginando o presente para transformar o futuro. Queremos estar perto e unidos na construção de narrativas que tragam solução, imaginação e propósito.`,
        paragraph4: `De exposições imersivas a campanhas gráficas, da identidade visual à animação, nossa equipe se mobiliza para dar forma a ideias que movem o mundo.`,
