  ...
  pt: {
    ...
    projects: {
      mongabay: {
        ...
        text3: "Os gráficos são automatizados para se adaptar às informações que são colocadas através de expressões que controlam o tamanho das caixas de texto, quantidade de linhas e etc, fazendo com que o editor mexa no mínimo de propriedades possível.",
